# Generated by Django 4.2.8 on 2023-12-29 14:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('preference', '0007_bannermodel'),
    ]

    operations = [
        migrations.CreateModel(
            name='TopTendingProductsModel',
            fields=[
                ...
                ('products', models.ManyToManyField(related_name='top_trending_products', to='product.productmodel', verbose_name='Products')),
            ...
            options={
                'verbose_name': 'Top Tending Product',
                'verbose_name_plural': 'Top Tending Products',
                'ordering': ('-created_at',),
            },
        ),
    ]
